...
if __name__ == "__main__":
    ...
    experiment_name = "spacy_stanza_combined_model_experiment_10"
    ...
    with mlflow.start_run(experiment_id=experiment_id) as run:
        ...
        artifact_path = "spacy_combined_model_experiment_10"
    ...
    # Register the Model
    model_name = "spacy_combined_ner_model_stanza_test_experiment_model_10"
    try:
